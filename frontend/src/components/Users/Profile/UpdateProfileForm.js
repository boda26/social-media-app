...
const UpdateProfileForm = ({computedMatch: {params: {id}}}) => {
    ...
    <div className="min-h-screen bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h3 className="mt-6 text-center text-2xl font-extrabold text-gray-300">
          Hi <span className="text-green-300">
            {userDetails?.firstName} {userDetails?.lastName}
          </span>! Do you want to update your profile?
        </h3>
        {/* {error} */}
        {serverErr || appErr ? <h2 className="text-red-300 text-center">
          {serverErr} {appErr}
        </h2> : null}
      </div>
